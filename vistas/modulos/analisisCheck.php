...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-lg-3">
        <a href="analisis" class="btn btn-info btn-block">Volver a Analisis</a><br><br>
      </div>
      <div class="col-lg-3">
        <button id="btnExportAnalisisCheck" class="btn btn-success btn-block">Exportar Excel</button><br><br>
      </div>
    </div>
        ...
        <div class="card">
            ...
            <table class="table table-hover table-bordered table-lg tablaAnalisis" id="table">
                ...
                <tbody>
                  ...
                  <script>
                    // Exportar Excel (analisisCheck)
                    $(document).on('click','#btnExportAnalisisCheck',function(){
                      window.location.href = 'fetch/analisis_check_export.php'
                    })
                  </script>
    ...
    .each(function(group,i){
      ...
      if(last != group){
        ...
        for (let j = 1; j < Object.keys(arr).length; j++) {
            ...
            row[0].children[4].innerText = adpv.toFixed(2)
            row[0].children[5].innerText = gdg.toFixed(2)
