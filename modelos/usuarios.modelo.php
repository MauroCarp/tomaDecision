...
class ModeloUsuarios{
	...
	/*=============================================
	MOSTRAR USUARIOS DISTINCT
	=============================================*/

	static public function MdlMostrarUsuariosDistinct($tabla, $distinct,$item, $valor){
	...
	static public function mdlIngresarUsuario($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, usuario, password, perfil, empresa) VALUES (:nombre, :usuario, :password, :perfil, :empresa)");
