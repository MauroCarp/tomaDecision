	...
	public function mostrarTablaCarpetas(){
		...
		$datosJson = '{
			...
			foreach ($carpetas as $key => $carpeta) {
                ...
                $button = "<a href='extensiones/fpdf/informesPdf.php?informe=carpeta&verInforme=true&idCarpeta=".$carpeta['idCarpeta']."' class='btn btn-primary' ".$boton." target='_blank'>Informe</a>";
